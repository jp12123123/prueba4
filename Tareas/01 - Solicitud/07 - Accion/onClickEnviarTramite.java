...
else if(comp_CHK_tieneCuentaSi.isChecked() && comp_TXT_cuenta.getValue().trim().equals("-"))
{
...
//VALIDACION DE CALLE O BARRIO
else if((comp_CHK_tieneCuentaNo.isChecked()  && comp_BANDBOX_calleFisicoSC.getValue().isEmpty() || comp_CHK_tieneCuentaNo.isChecked() &&  comp_TXT_calleFisicoSC.getValue().equals("-"))
         &&
        (comp_CHK_tieneCuentaNo.isChecked() && comp_BANDBOX_barrioSC.getValue().isEmpty() ||  comp_CHK_tieneCuentaNo.isChecked() && comp_TXT_barrioFisicoSC.getValue().equals("-")))
{
    Messagebox.show("Por favor seleccione una Calle o un Barrio en Domicilio Físico/Ubicación (Datos Cuenta)","Advertencia",null,null,null);          
}
//SI INGRESO CALLE
else if((comp_CHK_tieneCuentaNo.isChecked()  && !comp_BANDBOX_calleFisicoSC.getValue().isEmpty() || comp_CHK_tieneCuentaNo.isChecked() &&  !comp_TXT_calleFisicoSC.getValue().equals("-"))
       && (comp_CHK_tieneCuentaNo.isChecked() && comp_BANDBOX_barrioSC.getValue().isEmpty() ||  comp_CHK_tieneCuentaNo.isChecked() && comp_TXT_barrioFisicoSC.getValue().equals("-"))
      && (comp_CHK_tieneCuentaNo.isChecked() && comp_IN_calleFisicoNumeroSC.getValue().equals(0)))
{
    Messagebox.show("Por favor ingrese un Número en Domicilio Físico/Ubicación (Datos Cuenta)","Advertencia",null,null,null);
}

else if((comp_CHK_tieneCuentaNo.isChecked() && !comp_BANDBOX_barrioSC.getValue().isEmpty() ||  comp_CHK_tieneCuentaNo.isChecked() && !comp_TXT_barrioFisicoSC.getValue().equals("-"))
        && (comp_CHK_tieneCuentaNo.isChecked()  && comp_BANDBOX_calleFisicoSC.getValue().isEmpty() || comp_CHK_tieneCuentaNo.isChecked() &&  comp_TXT_calleFisicoSC.getValue().equals("-"))
    && (comp_CHK_tieneCuentaNo.isChecked() && comp_TXT_manzanaFisicoSC.getValue().trim().equals("-")))
{
    Messagebox.show("Por favor ingrese una Manzana en Domicilio Físico/Ubicación (Datos Cuenta)","Advertencia",null,null,null);
}

//SI INGRESO UN BARRIO
else if((comp_CHK_tieneCuentaNo.isChecked() && !comp_BANDBOX_barrioSC.getValue().isEmpty() ||  comp_CHK_tieneCuentaNo.isChecked() && !comp_TXT_barrioFisicoSC.getValue().equals("-"))
        && (comp_CHK_tieneCuentaNo.isChecked()  && comp_BANDBOX_calleFisicoSC.getValue().isEmpty() || comp_CHK_tieneCuentaNo.isChecked() &&  comp_TXT_calleFisicoSC.getValue().equals("-"))
    && (comp_CHK_tieneCuentaNo.isChecked() && comp_TXT_loteFisicosSC.getValue().trim().equals("-")))
{
...
// CUT - Tramitentes HIPOTECARIOS
}
else if(auxTramite && comp_CMB_condImposTrans.getValue().trim().equals("-") || comp_TXT_tipoIVAVendedor.equals("") || comp_TXT_tipoIVAVendedor.equals("-") )
{
    Messagebox.show("Por favor seleccione una Condición Impositiva para el Transmitente","Advertencia",null,null,null);
}
...
//ADQUIRIENTES
else if(auxTramite && comp_CMB_condImposAdq.getValue().trim().equals("-") || comp_TXT_condImposComprador.equals("") || comp_TXT_condImposComprador.equals("-") )
{
    Messagebox.show("Por favor seleccione una Condición Impositiva para el Adquirente","Advertencia",null,null,null);
}
...
else if(auxTramite && !comp_CHK_igualUbicacionPostalSi.isChecked() && !comp_CHK_igualUbicacionPostalNO.isChecked() )//|| auxTramite && !comp_CHK_igualUbicacionPostalNO.isChecked() )
{
...
else if(auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_NCT.isChecked() && comp_TXT_numeroPlano.getValue().trim().equals("-") && comp_IN_subParcelaCUT.getValue()==0)
{
    Messagebox.show("Por favor ingrese el número de plano en el Domicilio Físico/Ubicación.","Advertencia",null,null,null);

} 

else if(auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_NCG.isChecked() && comp_TXT_numeroPlano.getValue().trim().equals("-") && comp_IN_subParcelaCUT_GEO.getValue()==0)
{
    Messagebox.show("Por favor ingrese el número de plano en el Domicilio Físico/Ubicación.","Advertencia",null,null,null);
...
{
    Messagebox.show("Por favor ingrese el departamento del Domicilio Físico/Ubicación (Datos Cuenta) para Igual Ubicación","Advertencia",null,null,null);
}
...
{
    Messagebox.show("Por favor ingrese el distrito del Domicilio Físico/Ubicación (Datos Cuenta) para Igual Ubicación","Advertencia",null,null,null);
}

//VALIDACION IGUAL UBICACIÓN SI

//VALIDACION DE CALLE O BARRIO
else if((auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked()  && comp_BANDBOX_calleFisico.getValue().isEmpty() || auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() &&  comp_TXT_calleFisico.getValue().equals("-"))
         &&
        (auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() && comp_BANDBOX_barrio.getValue().isEmpty() ||  auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() && comp_TXT_barrioFisico.getValue().equals("-")))
{
    Messagebox.show("Por favor seleccione una Calle o un Barrio en Domicilio Físico/Ubicación (Datos Cuenta) para Igual Ubicación","Advertencia",null,null,null);          
}
//SI INGRESO CALLE
else if((auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked()  && !comp_BANDBOX_calleFisico.getValue().isEmpty() || auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() &&  !comp_TXT_calleFisico.getValue().equals("-"))
       && (auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() && comp_BANDBOX_barrio.getValue().isEmpty() ||  auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() && comp_TXT_barrioFisico.getValue().equals("-"))
      && (auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_IN_calleFisicoNumero.getValue().equals(0)))
{
    Messagebox.show("Por favor ingrese un Número en Domicilio Físico/Ubicación (Datos Cuenta) para Igual Ubicación","Advertencia",null,null,null);
}

else if((auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() && !comp_BANDBOX_barrio.getValue().isEmpty() ||  auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() && !comp_TXT_barrioFisico.getValue().equals("-"))
        && (auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked()  && comp_BANDBOX_calleFisico.getValue().isEmpty() || auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() &&  comp_TXT_calleFisico.getValue().equals("-"))
    && (auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_TXT_manzanaFisico.getValue().trim().equals("-")))
{
    Messagebox.show("Por favor ingrese una Manzana en Domicilio Físico/Ubicación (Datos Cuenta) para Igual Ubicación","Advertencia",null,null,null);
}

//SI INGRESO UN BARRIO
else if((auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() && !comp_BANDBOX_barrio.getValue().isEmpty() || auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() && !comp_TXT_barrioFisico.getValue().equals("-"))
        && (auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked()  && comp_BANDBOX_calleFisico.getValue().isEmpty() || auxTramite && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_CHK_tieneCuentaNo.isChecked() &&  comp_TXT_calleFisico.getValue().equals("-"))
    && (auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_TXT_loteFisicos.getValue().trim().equals("-")))
{
    Messagebox.show("Por favor ingrese un Lote en Domicilio Físico/Ubicación (Datos Cuenta) para Igual Ubicación","Advertencia",null,null,null);
}
...
else if(auxTramite && comp_CHK_tieneCuentaNo.isChecked() && comp_CHK_igualUbicacionPostalSi.isChecked() && comp_BANDBOX_barrio.getValue().isEmpty() && comp_IN_calleFisicoNumero.getValue().equals(0) && comp_BANDBOX_calleFisico.getValue().isEmpty() ){
...
{
    Messagebox.show("Por favor Ingrese un Numero en el Domicilio Postal.","Advertencia",null,null,null);
}
...
else if(auxTramite && comp_CHK_NCT.isChecked() && comp_DOU_segunTituloInmueble.getValue()==0 && comp_IN_subParcelaCUT.getValue()==0)
{                                           
    Messagebox.show("Por favor ingrese el numero Según Titulo en m2 (Superficie del Inmueble)","Advertencia",null,null,null);
}
else if(auxTramite && comp_CHK_NCT.isChecked() && comp_DOU_segunPlanoInmueble.getValue()==0 && comp_IN_subParcelaCUT.getValue()==0)
{
    Messagebox.show("Por favor ingrese el numero Según Plano en m2 (Superficie del Inmueble)","Advertencia",null,null,null);
}
else if(auxTramite && comp_CHK_NCT.isChecked() && comp_DOU_supTituloTransferirM2.getValue()==0 && comp_IN_subParcelaCUT.getValue()==0)
{
    Messagebox.show("Por favor ingrese el numero Según Titulo en m2 (Superficie a Transferir)","Advertencia",null,null,null);
}
else if(auxTramite && comp_CHK_NCT.isChecked() && comp_DOU_supPlanoTrasferir.getValue()==0 && comp_IN_subParcelaCUT.getValue()==0)
{
    Messagebox.show("Por favor ingrese el numero Según Plano en m2 (Superficie a Transferir)","Advertencia",null,null,null);

}

else if(auxTramite && comp_CHK_NCG.isChecked() && comp_DOU_segunTituloInmueble.getValue()==0 && comp_IN_subParcelaCUT_GEO.getValue()==0)
{                                           
    Messagebox.show("Por favor ingrese el numero Según Titulo en m2 (Superficie del Inmueble)","Advertencia",null,null,null);
}
else if(auxTramite && comp_CHK_NCG.isChecked() && comp_DOU_segunPlanoInmueble.getValue()==0 && comp_IN_subParcelaCUT_GEO.getValue()==0)
{
    Messagebox.show("Por favor ingrese el numero Según Plano en m2 (Superficie del Inmueble)","Advertencia",null,null,null);
}
else if(auxTramite && comp_CHK_NCG.isChecked() && comp_DOU_supTituloTransferirM2.getValue()==0 && comp_IN_subParcelaCUT_GEO.getValue()==0)
{
    Messagebox.show("Por favor ingrese el numero Según Titulo en m2 (Superficie a Transferir)","Advertencia",null,null,null);
}
else if(auxTramite && comp_CHK_NCG.isChecked() && comp_DOU_supPlanoTrasferir.getValue()==0 && comp_IN_subParcelaCUT_GEO.getValue()==0)
{
    Messagebox.show("Por favor ingrese el numero Según Plano en m2 (Superficie a Transferir)","Advertencia",null,null,null);
...
{                                           
    Messagebox.show("Por favor seleccione el Destino para PH","Advertencia",null,null,null);
}
...
{
    org.zkoss.zul.Messagebox.show("¿Seguro que desea empezar un nuevo tramite?", "Atención", org.zkoss.zul.Messagebox.YES | org.zkoss.zul.Messagebox.NO, org.zkoss.zul.Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener()
    {
        public void onEvent(org.zkoss.zk.ui.event.Event evt)
        {
            switch (((Integer) evt.getData()).intValue())
            {
                ...
                if(comp_CHK_tieneCuentaNo.isChecked())
                {
                    String auxCUit = comp_TXT_CUITPersona.getValue();
                    auxCUit = auxCUit.replaceAll("-", "");

                    String auxdni = comp_TXT_DNIPersona.getValue();
                    
                    if(comp_TXT_DNIPersona.getValue().equals("-"))
                    {
                        auxdni = "1";
                    }
                                                
                    java.util.List parametrosfnAltaClienteTr = new java.util.ArrayList();
                        parametrosfnAltaClienteTr.add(typePers); //type_cli / String
                        parametrosfnAltaClienteTr.add(auxdni); //dni_cli / String
                        parametrosfnAltaClienteTr.add(comp_TXT_nombrePersonaNO.getValue()); //nombre_cli / String
                        parametrosfnAltaClienteTr.add(comp_TXT_apellidoPersonaNO.getValue()); //apellido_cli / String
                        parametrosfnAltaClienteTr.add(comp_TXT_razonSocialPersonaNO.getValue()); //razon_social_cli / String
                        parametrosfnAltaClienteTr.add(comp_TXT_TipoIVAVendedor1.getValue()); //tre_codigo_cli / String
                        parametrosfnAltaClienteTr.add(auxCUit); //cuit_cli / String
                        parametrosfnAltaClienteTr.add(comp_TXT_idEscribano.getValue()); //mes_id / String
                    new modelos.builder.eventos.ModeloEventos().ejecutarFuncion("fnAltaClienteTr",parametrosfnAltaClienteTr);
                    Map return34mapa=(Map) ((org.zkoss.zul.Window) org.zkoss.zk.ui.Executions.getCurrent().getDesktop().getAttribute("winBuilder")).getAttribute("return34mapa");
                    String codigoDevuelto = return34mapa.get("P_CODIGO").toString();
                    String valorCliId = return34mapa.get("P_MENSAJE").toString();
                    comp_TXT_cli_id.setValue(valorCliId);
                    
                    if(codigoDevuelto.equals("0"))
                    {
                        ...
                        //parametrosfnGuardar.add(true); //alIniciador / Boolean
                        ...
                        String numDocumentoElectronico= (String)org.zkoss.zk.ui.Executions.getCurrent().getDesktop().getAttribute("numDocumentoElectronico");
                        nb = (Long)  winBuilder.getAttribute("procesoID");
                        if(nb==0 || nb==null)
                        {
                            org.bonitasoft.engine.bpm.flownode.ActivityInstance actividad = ( org.bonitasoft.engine.bpm.flownode.ActivityInstance) winBuilder.getAttribute("actividad");
                            String numDocumentoElectronico= (String) winBuilder.getAttribute("nexp");
                            nb = actividad.getParentProcessInstanceId();
                        }
                        mensaje="Se inició el Documento Electronico N°: " + numDocumentoElectronico;
                        Messagebox.show(""+mensaje,"Advertencia",null,null,null);
                    }
                    else if(codigoDevuelto.equals("1"))
                    {
                        Messagebox.show(valorCliId);
                    }
                }
                else 
                {
