...
if(comp_CHK_tieneCuentaNo.isChecked()){
    ...
    //if(!comp_TXT_nombrePersonaNO.getValue().trim().equals("-") && ((!comp_TXT_DNIPersona.getValue().trim().equals("-") && comp_TXT_CUITPersona.getValue().trim().equals("-")) || (comp_TXT_DNIPersona.getValue().trim().equals("-") && !comp_TXT_CUITPersona.getValue().trim().equals("-")))){
      //  Messagebox.show("Entro, tipo: "+ typePers);
    ...
    //Messagebox.show("Afuera, tipo: "+ typePers);
}
...
/*}else if(comp_CHK_tieneCuentaNo.isChecked() && comp_TXT_DNIPersona.getValue().trim().equals("-") && typePers.equals("PFI")){
    Messagebox.show("Por favor ingrese un DNI para su cuenta","Advertencia",null,null,null);*/
...
}else if(auxTramite && comp_CMB_condImposTrans.getValue().trim().equals("-")){
    Messagebox.show("Por favor seleccione una Condición Impositiva para el Transmitente","Advertencia",null,null,null);
}else if(auxTramite && comp_CMB_condImposAdq.getValue().trim().equals("-")){
                ...
                switch (((Integer) evt.getData()).intValue())
                {
                        case Messagebox.YES:
                           ...
                           if(comp_CHK_tieneCuentaNo.isChecked()){
                                ...
                                //Messagebox.show("Tipo persona: "+typePers+"\n DNI: "+comp_TXT_DNIPersona.getValue()+"\n CUIT: "+comp_TXT_CUITPersona.getValue()+"\n NOMBRE: "+comp_TXT_nombrePersonaNO.getValue()+"\n APELLIDO: "+comp_TXT_apellidoPersonaNO.getValue()+"\n RAZÓN SOCIAL: "+comp_TXT_razonSocialPersonaNO.getValue()+"\n CODIGO: "+comp_TXT_TipoIVAVendedor1.getValue()+"\n ESCRIBANO: "+comp_TXT_idEscribano.getValue());
                                ...
                                //Messagebox.show("CODIGO: "+codigoDevuelto+"\n MENSAJE: "+valorCliId);
