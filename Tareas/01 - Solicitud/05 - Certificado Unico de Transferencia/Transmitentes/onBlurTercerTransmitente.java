...
Textbox txtDni = (Textbox) sup.getInstanciaComponente("comp_TXT_dniTramitente3");
...
//PERSONA FISICA - VALIDA DNI
    ...
    if (!matcherOrden.matches()) {
        Messagebox.show("Por favor, ingrese correctamente el DNI del tercer Transmitente/Hipotecario", "Advertencia", null, null, null);
        txtDni.setValue("-");
    }
}
...
public void validarCUIT(){
    ...
    String cuit = "";
        ...
        if (txtDni.getValue().trim().equals("-")) {
            Messagebox.show("Por favor, cargue el CUIT del tercer Transmietente/Hipotecario", "Advertencia", null, null, null);
