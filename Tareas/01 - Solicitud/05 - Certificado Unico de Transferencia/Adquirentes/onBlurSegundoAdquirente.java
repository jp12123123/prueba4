...
Textbox txtDni = (Textbox) sup.getInstanciaComponente("comp_TXT_personaAdquirente2DNI");
...
//PERSONA FISICA - VALIDA DNI
    ...
    if (!matcherOrden.matches()) {
        Messagebox.show("Por favor, ingrese correctamente el DNI del segundo Adquirente", "Advertencia", null, null, null);
        txtDni.setValue("-");
    }
}
...
public void validarCUIT(){
    ...
    String cuit = "";
        ...
        if (txtDni.getValue().trim().equals("-")) {
            Messagebox.show("Por favor, cargue el CUIT del segundo Adquirente", "Advertencia", null, null, null);
