...
String itemCombo = comp_CMB_condImposAdq.getValue().toString();
    ...
    switch (itemCombo){
        ...
        comp_TXT_condImposComprador.setValue("1");
        ...
        if(comp_RA_personaFisicaJuridica.getSelectedIndex()==0){ //física
            ...
            comp_TXT_dniTramitente1.setVisible(true);
            comp_TXT_dniTramitente2.setVisible(true);
            comp_TXT_dniTramitente3.setVisible(true);
            ...
            comp_TXT_CUT_ADQUIERE_CUIT1.setValue("-");
            comp_TXT_CUT_ADQUIERE_CUIT2.setValue("-");
            comp_TXT_CUT_ADQUIERE_CUIT3.setValue("-");
        ...
        comp_TXT_condImposComprador.setValue("2");
        ...
        if(comp_RA_personaFisicaJuridica.getSelectedIndex()==0){
            ...
            comp_TXT_dniTramitente1.setVisible(false);
            comp_TXT_dniTramitente2.setVisible(false);
            comp_TXT_dniTramitente3.setVisible(false);
        ...
        comp_TXT_condImposComprador.setValue("4");
        radioJuridica.setDisabled(false);
        ...
        comp_TXT_condImposComprador.setValue("6");
        radioJuridica.setDisabled(false);
        ...
        comp_TXT_condImposComprador.setValue("7");
        radioJuridica.setDisabled(false);
