...
//comp_CHK_Revision.setChecked(false);
...
//OCULTAR BOTON ARCHIVAR DE TAREA SEGUN TRAMITE
//Button comp_SAVE_ArchivarT=(Button) sup.getInstanciaComponente("comp_SAVE_ArchivarT");
//comp_SAVE_ArchivarT.setVisible(false);
...
Textbox comp_TXT_nroCuenta=(Textbox) sup.getInstanciaComponente("comp_TXT_nroCuenta");
...
Textbox comp_TXT_auxiliarNroCuenta=(Textbox) sup.getInstanciaComponente("comp_TXT_auxiliarNroCuenta");

//DATOS TRAMITE
if(comp_TXT_nroTramite.getValue().equals("-") || comp_TXT_nroTramite2da.getValue().equals("-")){
    comp_TXT_nroTramite2da.setValue(comp_TXT_auxiliarNroTramite.getValue());
    comp_TXT_nroTramite.setValue(comp_TXT_auxiliarNroTramite.getValue());
}

if(comp_TXT_nroTicket.getValue().equals("-") || comp_TXT_nroTicket2da.getValue().equals("-")){
    comp_TXT_nroTicket2da.setValue(comp_TXT_auxiliarNroTicket.getValue());
    comp_TXT_nroTicket.setValue(comp_TXT_auxiliarNroTicket.getValue());
}

/*if(comp_TXT_nroCuenta.getValue().equals("-") || comp_TXT_nroCuenta2da.getValue().equals("-")){
    comp_TXT_nroCuenta2da.setValue(comp_TXT_auxiliarNroCuenta.getValue());
    comp_TXT_nroCuenta.setValue(comp_TXT_auxiliarNroCuenta.getValue());
}*/
